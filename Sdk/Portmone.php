...
namespace CodeCustom\Portmone\Sdk;

use CodeCustom\Portmone\Sdk\Core\Portmone as PortmoneCoreSdk;
...
class Portmone extends PortmoneCoreSdk
{
    ...
    private function getOrder($orderIncrementId, $orderGrandTotal)
    {
        return [
            ...
            'billCurrency' => 'UAH',
            'encoding' => '',
            'attribute1' => isset($_SERVER['HTTP_REFERER']) && $this->_helper->getFrontRedirectUrl()
